...
<div class="container register">
    <h1 class="title-student-list">TOURISM LABORATORIES</h1>
    <div class="row">
                            ...
                            <table class="table table-striped table-hover table-bordered">
                                ...
                                <?php foreach ($students as $student) : ?>
                                    <tr>
                                        ...
                                        <td><img id="selectedAvatar" src="<?= BASE_URL . $student['qr_code']; ?>" style="width: 200px; height: 200px; object-fit: contain;" /></td>
                                        <td>
